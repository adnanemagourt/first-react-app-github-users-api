...
const UserContextProvider = ({ children }) => {
    ...
    const addUser = (login, type, site_admin) => {
        const biggestId = Math.max.apply(Math, users.map(function(o) { return o.id; }));
        const newUser = {
            login,
            id: biggestId + 1,
            node_id: uuidv4(),
            avatar_url: `https://avatars.githubusercontent.com/u/${biggestId + 1}?v=4`,
            gravatar_id: "",
